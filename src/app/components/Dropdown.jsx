...
export default function UserDropdown() {
  ...
  useEffect(() => {
   ...
   { 
    ...
    const root_url = "https://tambaltech.com/wp-json/wp/v2/users/me";
    let config = {
      headers: {
  ...
  return (
    ...
    <div className="dropdown inline-block relative">
      ...
      <div className="flex items-center gap-x-2">
       { userInfo.avatar_urls &&
        <img className="object-cover w-8 h-8 rounded-lg" src={userInfo.avatar_urls['24']} alt=""/>}
        <div>
            <h1 className="text-base font-semibold text-gray-700 capitalize dark:text-white">{userInfo.name}</h1>            
        </div>
    </div>
